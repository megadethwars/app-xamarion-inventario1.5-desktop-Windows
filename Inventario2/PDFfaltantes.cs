...
{
    public class PDFfaltantes : ContentPage
    {
        DataTable table;
        string IdSalida;
        string correo;
        ...
        public async Task InitPDFAsync(string idSalida, List<ModelDevice> a)
        {
        ...
        public bool CreatePDF(ModelDevice movimientos, DataTable tablacarrito, int tipomov)
        {
            try
            {
                ...
                PdfTextElement lbusuario = new PdfTextElement(CurrentUser.nombre + " " + CurrentUser.apellido_paterno, usuariofont);
